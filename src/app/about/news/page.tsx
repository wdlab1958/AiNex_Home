            ...
            <section className="container mx-auto px-4 mb-20 text-center">
                ...
                >
                    ...
                    <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                        WDLAB@2023-2026와 AiNex의 최신 소식, 보도자료, 그리고 기술 업데이트를 만나보세요.
                    </p>
                </motion.div>
            </section>
...
const pressReleases: PressRelease[] = [
    {
        ...
        date: '2026.01.05',
        title: 'WDLAB@2023-2026, AI 컨설팅 자동화 플랫폼 \'AiNex\' 정식 출시',
        summary: '26년 보안 노하우와 LLM 기술을 결합한 기업용 AI 전환 솔루션 선보여...',
        content: `WDLAB@2023-2026(대표 한재호)는 26년간 축적한 보안 컨설팅 노하우와 최신 LLM(대규모 언어 모델) 기술을 결합한 기업용 AI 전환 솔루션 'AiNex'를 정식 출시했다고 5일 밝혔다.
...
WDLAB@2023-2026 한재호 대표는 "AiNex는 단순한 AI 도구가 아닌, 기업의 AI 전환을 안전하고 효과적으로 이끄는 파트너"라며 "26년간 쌓아온 보안 전문성을 바탕으로 신뢰할 수 있는 AI 솔루션을 제공하겠다"고 말했다.
...
AiNex는 금융, 의료, 제조 등 다양한 산업군을 대상으로 서비스를 시작하며, 올해 상반기 중 해외 시장 진출도 계획하고 있다.`
    },
    {
        ...
        date: '2025.12.20',
        title: 'WDLAB@2023-2026 - 글로벌 클라우드 기업과 전략적 파트너십 체결',
        summary: 'Sovereign AI 구축을 위한 하이브리드 클라우드 인프라 협력 강화...',
        content: `WDLAB@2023-2026(대표 한재호)가 글로벌 클라우드 서비스 기업과 전략적 파트너십을 체결하고, Sovereign AI 구축을 위한 하이브리드 클라우드 인프라 협력을 강화한다고 20일 발표했다.
...
WDLAB@2023-2026 한재호 대표는 "이번 파트너십을 통해 기업들이 데이터 주권을 유지하면서도 글로벌 수준의 AI 인프라를 활용할 수 있게 되었다"며 "앞으로도 고객의 AI 전환을 위한 최적의 환경을 제공하겠다"고 밝혔다.`
    },
    {
        id: 3,
        category: 'Award',
        ...
        content: `WDLAB@2023-2026의 AI 에이전트 개발 플랫폼 'AgentForge'가 '2025 대한민국 AI 대상'에서 '올해의 혁신 플랫폼' 부문 대상을 수상했다.
...
WDLAB@2023-2026 한재호 대표는 "이번 수상은 AgentForge의 기술력과 비전을 인정받은 것"이라며 "앞으로도 기업의 AI 혁신을 선도하는 플랫폼으로 발전시켜 나가겠다"고 소감을 전했다.`
    }
];
...
const notices: Notice[] = [
    { 
        ...
        date: '2026.01.08',
        content: `안녕하세요, WDLAB@2023-2026입니다.
...
감사합니다.`
    ...
    { 
        ...
        date: '2025.12.28',
        content: `WDLAB@2023-2026와 함께 AI의 미래를 만들어갈 인재를 찾습니다.
...
■ 지원 방법
careers@wdlab.com으로 이력서 및 자기소개서 제출
