...
export function Footer() {
  return (
    <footer className="relative z-10 bg-nebula-navy-100/95 backdrop-blur-sm border-t border-slate-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navConfig.footerNav.company.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navConfig.footerNav.products.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-slate-400 hover:text-white transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navConfig.footerNav.resources.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-slate-400 hover:text-white transition-colors"
